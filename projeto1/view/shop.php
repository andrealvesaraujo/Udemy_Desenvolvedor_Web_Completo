...
<section ng-controller="destaque-controller">
	...
	<div class="container" id="destaque-produtos-container">	
		...
		<div class="destaque-produtos owl-carousel owl-theme">
				...
				<div class="row">
					...
					<div class="col-sm-6 col-descricao">
						...
						<div class="box-valor">
							...
							<div class="text-parcelas text-arial-cinza">ou em ate {{produto.parcelas}}x de R$ {{produto.parcela}}</div>
	...
	<div id="mais-buscados" class="container">
		...
		<div class="container text-center title-default-roxo">
...
/*
	//Isso é o formato json feito estaticamente
	$scope.produtos.push({
...
/*$(function(){
	...
	//Isso funcionou sem o var InitialCarousel
